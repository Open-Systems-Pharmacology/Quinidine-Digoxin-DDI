...
Modeling of published quinidine-digoxin-DDI studies for model evaluation

## Repository files
Within this repository, we distribute a PK-Sim snapshot and a PK-Sim model file containing simulations of all published clinical studies used to evaluate the predictive performance of the quinidine model regarding quinidine-digoxin-DDIs, including the respective observed data digitized from literature reports. The applied digoxin model has been published previously [1]. For further details and documentation please refer to [2].
